...
describe('login page', () => {
  ...
  it('should get username input box', () => {
    ...
    .toBeTruthy(`<input matInput type="text" placeholder="Enter userName" name="userName"> should exist in login.component.html`);
  });

  it('should get passsword input box', () => {
    page.navigateToLogin();
    expect(page.isPasswordInputBoxPresent())
    .toBeTruthy(`<input type="password" matInput name="password">
      should exist in login.component.html`);
  });

  it('should get submit button', () => {
    page.navigateToLogin();
    expect(page.isSubmitButtonPresent()).toBeTruthy(`<button type="submit" mat-raised-button>Login</button> should
