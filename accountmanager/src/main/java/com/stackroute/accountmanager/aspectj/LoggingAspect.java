...
public class LoggingAspect {
	...
	@Before("execution(* com.stackroute.accountmanager.controller.AccountManagerController.registerUserToDB(..))")
	public void beforelog(JoinPoint joinPoint) {
		logger.info("Inside Before Advice ....");
		logger.info("Target object method : "+ joinPoint.getSignature().getName());
	}
	
	@After("within(com.stackroute.accountmanager.controller..*)")
	public void afterLog(JoinPoint joinPoint) {
		logger.info("Inside After Advice ......");
		logger.info("Target object method : "+ joinPoint.getSignature().getName());
	}
	
	@AfterReturning("within(com.stackroute.accountmanager.controller..*)")
	public void afterReturningLog(JoinPoint joinPoint) {
		logger.info("Inside After Throwing Advice ......");
		logger.info("Target object method : "+ joinPoint.getSignature().getName());
	}
	
	@AfterThrowing("within(com.stackroute.accountmanager.controller..*)")
